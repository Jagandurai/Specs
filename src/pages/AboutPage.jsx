...
import mainImgComp1 from '../assets/img/unsplash/frame-13.jpg';
import mainImgComp2 from '../assets/img/unsplash/frame-10.jpg';
import mainImgComp3 from '../assets/img/unsplash/sun-11.jpg';

import eyecareImg from '../assets/img/unsplash/store-7.jpg';
import eyecareImgComp from '../assets/img/unsplash/store-7.jpg';

function AboutPage() {
  useEffect(() => {
    document.title = 'The Experience | Glasses Eyewear Online Store';
  }, []);
    ...
    <main className="story">
      <section className="story-header">
        ...
        <p className="story-header__text">
          ...
          Elevate your eyewear game with Glasses Eyewear frames.
        </p>
      </section>
      ...
      <section className="story-main">
        ...
        <div className="story-main__panel panel-2 about-us">
          ...
          <p className="story-main__text">
            It was born of a simple mission - to create high-quality,
        ...
        <div className="story-main__panel panel-3 eyeglasses">
          ...
          <p className="story-main__text">
            At Glasses Eyewear, we believe that everyone should have access to stylish
