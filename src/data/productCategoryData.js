...
import imgCompressedAllProducts from '../assets/img/unsplash/frame-9.jpg';
import imgCompressedSunglasses from '../assets/img/unsplash/sun-1.jpg';
import imgCompressedEyeglasses from '../assets/img/unsplash/frame-7.jpg';

import { allProductsData, sunglassesData, eyeglassesData } from './productData';

export const allProductsCategoryData = {
  documentTitle: 'COLLECTION | Shop all products - Glasses Eyewear Store',
  banner: {
    title: 'All Products',
    description:
...
export const eyeglassesCategoryData = {
  documentTitle: 'OPTICAL | Trendy Frames & Styles - Glasses Eyewear Store',
  banner: {
    title: 'Optical Shop',
    description:
...
export const sunglassesCategoryData = {
  documentTitle: 'SUNGLASSES | Trendy Frames & Styles - Glasses Eyewear Store',
  banner: {
    title: 'Sunnies Store',
    description:
