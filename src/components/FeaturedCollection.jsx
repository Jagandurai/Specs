...
import imgCompressed1 from '../assets/img/unsplash/ad-3.jpg';
import img2 from '../assets/img/unsplash/frame-12.jpg';
import imgCompressed2 from '../assets/img/unsplash/frame-12.jpg';
    ...
    <section className="featured-coll">
      <div className="featured-coll__col-1">
        <div className="featured-coll__text-wrapper">
          <h4 className="featured-coll__title">Glasses Eyewear</h4>
          <p className="featured-coll__details">
            Crafted with care, each pair of glasses is a unique statement
